...
- nom : Esnaux
- prénom : Virgile
- URL Netlify : https://ephemeral-druid-47a6bb.netlify.app/
...
```js
nav.ariaHidden = "false"; // ou: nav.setAttribute("aria-hidden", "false");
```
...
```js
toggle.ariaExpanded = "true"; // ou: toggle.setAttribute("aria-expanded", "true");
```
...
toggle.addEventListener("click", () => {
  ...
  // (exemple simple d'ouverture — pour l'alternance, voir toggle plus bas)
